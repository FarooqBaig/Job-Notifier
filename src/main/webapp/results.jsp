...
<%@page import="com.registeration.Posts" %>
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">Job Notifier</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Job Notifier</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Easy - Quick - Worth -  jobs at one place.</p>
		</div>
	</header>
	...
	<%ArrayList<Posts> allJobs = 
	    (ArrayList<Posts>)request.getAttribute("data");
	for(Posts p : allJobs){%>
	<tr>
	  <td><%=p.getSNO()%></td>
	    <td><%=p.getJobTitle()%></td>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">JobNotifier is a free website created by
						<a href="https://www.linkedin.com/in/farooq-baig-1861601b2" style="color:white;">Me</a>. The download includes the complete source files
						including HTML, CSS, and JavaScript as well as optional SASS
						stylesheets for easy customization.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">You can get all the jobs information at one place.
					      for any suggestions or queries contact me from the below forms</p>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Vijayawada , Andhra Pradesh  <br /> India
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About JobNotifier</h4>
					<p class="lead mb-0">
						JobNotifier is a free to use website created
						by <a href="https://github.com/FarooqBaig/Job-Noifier">Farooq Baig</a> .
					</p>
				</div>
			</div>
		</div>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<p class="mb-4">Building an own house is every individuals Dream. This dream comes true when 
								You have a beautiful job and stable income. So, Don't wait go and search for your dream job.</p>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<!-- Portfolio Modal - Text-->
								<p class="mb-4">Companies offer food services to their  </p>
								<button class="btn btn-primary" href="#!"
									data-bs-dismiss="modal">
									<i class="fas fa-times fa-fw"></i> Close Window
								</button>
